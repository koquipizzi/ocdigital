...
return [
    ...
    'Error' => '',
    'File upload failed.' => '',
    'Invalid compare value date format: {value}' => '',
    'Invalid data received for parameter "{param}".' => '',
    'Invalid value date format: {value}' => '',
    'Login Required' => '',
    ...
    'Create' => 'Crear',
    '(not set)' => 'Sin datos',
    'Are you sure you want to delete this item?' => 'Estas seguro que desea borrar este item?',
    'Delete' => 'Eliminar',
    'Home' => 'Inicio',
    'No results found.' => 'No existe información',
    ...
    '{attribute} cannot be blank.' => 'El campo {attribute} es obligatorio',
    '{attribute} must be an integer.' => '{attribute} tiene que ser entero',
    '{attribute} must be greater than or equal to "{compareValueOrAttribute}".' => '{attribute} tiene que se mayor o igual a "{compareValueOrAttribute}".',
    '{attribute} must be greater than or equal to "{compareValue}".' => 'La {attribute} tiene que ser de mayor o igual a la Fecha Actual',
    '{attribute} must be less than or equal to "{compareValue}".' => '{attribute} debe ser del dia de la fecha',
];
