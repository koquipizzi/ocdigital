            ...
            $(document).on('ready pjax:success', function () { 
                $('#modal').addClass('modal-primary');
                  $('.loadMainContentPrestadora').click(function(){ 
                    ...
                    $('#modal').find('.modal-header').html('Nueva Entidad Facturable');
                    $('#modal').find('#modalContent').load($(this).attr('value'));
                    $('#modal').modal('show');
                });
                
                $('.editar').click(function(e){  
                    $('#modal').find('.modal-header').html('Editar Entidad Facturable');
                    $('#modal').find('#modalContent').load($(this).attr('value'));
                    $('#modal').modal('show');
                });
                
                $('.ver').click(function(e){  
                    $('#modal').find('.modal-header').html('Ver Entidad Facturable');
                    $('#modal').find('#modalContent').load($(this).attr('value'));
                    $('#modal').modal('show');
                });
