...
class m180611_214536_estadoProximo_inserts extends Migration
{
    ...
    public function safeUp()
    {
        ...
        $this->insert("estado_proximo",["estado_origen_id"=>1,"estado_destino_id"=>1]);
        ...
        $this->insert("estado_proximo",["estado_origen_id"=>2,"estado_destino_id"=>2]);
        ...
        $this->insert("estado_proximo",["estado_origen_id"=>3,"estado_destino_id"=>3]);
