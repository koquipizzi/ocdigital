...
class m180618_154702_nuevos_pahts_viajante extends Migration
{
    ...
    public function safeUp()
    {
        ...
        $this->insert("auth_item", ["name"=>'/pedido/delete',"type"=>2,"created_at"=>"1528818752","updated_at"=>"1528818752"]);
    ...
    public function safeDown()
    {
        ...
        $this->delete("auth_item_child", ["parent"=>"Viajante","child"=>"/pedido/delete"]);
