...
function wcplpro_not_sortable(){
  ...
  $notsoratble = array(
    ...
    'wcplpro_filters_position' => __('Dropdown filters Position', 'wcplpro'),
  ...
  <div class="wrap">
    ...
    <div class="<?php if ($hidebar !=1) { echo 'leftpanel'; } ?>">    
      <form method="post" action="options.php">
            ...
            echo '
            <div class="fieldwrap">
              <label class="vm_label" for="wcplpro_filters_position">'. __('Dropdown filters Position', 'wcplpro') .'</label>
    ...
    <div class="rightpanel">
      ...
      <div class="plugitem">
        ...
        <a href="https://codecanyon.net/item/woocommerce-variations-to-table-grid/10494620" title="Woocommerce Products to Table - Grid" target="_blank" class="img">
          <img src="https://image-cc.s3.envato.com/files/203140636/vartable-inline-preview-image.png" width="590" height="300" alt="Woocommerce Products to Table - Grid"/>
        </a>
      </div>
      ...
      <div class="plugitem">
        ...
        <a href="https://codecanyon.net/item/cart-to-quote-for-woocommerce/17477111" title="Cart to Quote for Woocommerce" target="_blank" class="img">
          <img src="https://0.s3.envato.com/files/204117602/woo-cart-to-quote-inline.png" width="590" height="300" alt="Cart to Quote for Woocommerce"/>
        </a>
      </div>
      ...
      <div class="plugitem">
        ...
        <a href="http://codecanyon.net/item/woocommerce-export-products-to-xls/9307040" title="Woocommerce Export Products to XLS" target="_blank" class="img">
          <img src="https://image-cc.s3.envato.com/files/130996525/wooxls-inline-preview-image.png" width="590" height="300" alt="Woocommerce Export Products to XLS"/>
        </a>
      </div>
      ...
      <div class="plugitem">
        ...
        <a href="http://codecanyon.net/item/woocommerce-lowest-price-match/12156217" title="Woocommerce Lowest Price Match" target="_blank" class="img">
          <img src="https://image-cc.s3.envato.com/files/184547121/wbpm-inline-preview-image.png" width="590" height="300" alt="Woocommerce Lowest Price Match"/>
        </a>
      </div>
