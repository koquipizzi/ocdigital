...
function wcplpro_insert_dialog() {
  ...
  $out .= '</select>
    ...
    <tr>
      <td class="first_column">
        <label id="wcplpro_posts_inc-l" class="mce-widget mce-label mce-first" for="wcplpro_posts_inc" aria-disabled="false">'. __('Include Products', 'wcplpro').'<br /><small>'.__('(enter IDs eg. 14,22,73)', 'wcplpro') .'</small></label>
      </td>
      <td class="setting_value">
    ...
    <tr>
      <td class="first_column">
        <label id="wcplpro_posts_exc-l" class="mce-widget mce-label mce-first" for="wcplpro_posts_exc" aria-disabled="false">'. __('Exclude Products', 'wcplpro') .'<br /><small>'.__('(enter IDs eg. 14,22,73)', 'wcplpro') .'</small></label>
      </td>
      <td class="setting_value">
    ...
    <tr>
      <td class="first_column">
        <label id="wcplpro_filters_position-l" class="mce-widget mce-label mce-first" for="wcplpro_filters_position" aria-disabled="false">'. __('Dropdown filters Position', 'wcplpro') .'</label>
      </td>
      <td class="setting_value">
